...
const Text = () => {
  return (
    <div className="relative top-5 h-1/2 flex flex-col gap-5 justify-center items-center z-10">
      <div className="bg-blue-500 rounded-full px-3 text-gray-200 font-bold ">
        Components for Lazy Gen-Z's 🙂‍↔️
      </div>
      <h1 className="flex flex-col items-center">
        <span className="font-bold text-[50px]">Make Your App Stand Out</span>
        <span className="font text-[50px]">from Crowd.</span>
      </h1>
      <div>
        <span className="text-gray-300">
          These Components Will Put Your Web-App to Sky-Rocket and So Integrate
          It right now it just{" "}
          <span className="text-green-500 bg-slate-600 rounded-full px-2">
            Copy Paste
          </span>{" "}
          Components
        </span>
