    ...
    <div className="relative h-1/2 flex flex-col px-20 py-10 gap-5 ">
      ...
      <div className="flex justify-between">
        <div className="flex flex-col gap-3">
          <div className="bg-blue-200 rounded-full w-fit px-3 text-blue-800  ">
            Testimonials
          </div>
          <div className="font-bold text-2xl w-fit">
            What Procaster's wanna Say!
          </div>
          <p className="text-zinc-400">
            These Components are so Amazing that , we even get Dreams of these
            Components! 😁
          </p>
        </div>
        <div>Left Right</div>
      ...
      <div className="relative flex top-2 gap-7 overflow-clip">
        {images.map((item, index) => (
          <div
            className="relative flex flex-col justify-center items-center h-80 w-80 bg-black border-2 border-blue-300 rounded-xl overflow-hidden"
            key={index}
          >
